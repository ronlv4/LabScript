...
def findErrorForChi2overNDOFis1(function, start, end, dx):
...
# y_err=findErrorForChi2overNDOFis1(linear_fun, 0.006, 0.007, 0.00000001)
...
ax.set_title("Rotation Distance as Function of Rings Created", fontdict={"size": 24, "weight": "bold"})
